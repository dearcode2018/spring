/**
  * @filename UserFullAnnoAspectWithParam.java
  * @description  
  * @version 1.0
  * @author qye.zheng
 */
...
import com.hua.bean.User;
 ...
 /**
 * @type UserFullAnnoAspectWithParam
 * @description  
 * @author qye.zheng
 */
// 该类对象需要被代理，因此不能声明为final
//@Aspect
public class UserFullAnnoAspectWithParam {
	 ...
	 * @author qye.zheng
	 */
	@Pointcut("execution(* com.hua.service.*.*(com.hua.bean.User,..)) && args(sundayBean,..)")
	 ...
	 */
	/*
	 * 	<aop:pointcut id="userBusinessCut" expression="execution(* com.hua.service.*.*(com.hua.bean.User,..)) and args(sundayBean)" />
	 * <aop:before pointcut-ref="userBusinessCut" method="doBefore" arg-names="sundayBean"/>
	 * 这样配置 才能正确注入值
	 */
	//public void doBefore(final User sundayBean)
	// 暂时实现不了
	//public void doBefore(final String msg)
	// 这种方式是不行的: @Before(value = "userBusinessCut", argNames = "sundayBean")
	@Before(value = "userBusinessCut(sundayBean)")
	 ...
	 * @author qye.zheng
	 */
	//@Around(value = "userBusinessCut(sundayBean)")
	 ...
	 * @author qye.zheng
	 */
	@AfterThrowing(pointcut = "userBusinessCut(sundayBean)", throwing = "throwable")
	 ...
	 * @author qye.zheng
	 */
	@AfterReturning(pointcut = "userBusinessCut(sundayBean)", returning = "returning")
	 ...
	 * @author qye.zheng
	 */
	@After(value = "userBusinessCut(sundayBean)")
