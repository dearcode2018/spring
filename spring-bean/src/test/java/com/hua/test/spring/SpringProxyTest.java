...
import com.hua.service.impl.MondayImpl;
...
@ContextConfiguration(locations = {"classpath:conf/xml/spring-bean.xml"})
public final class SpringProxyTest extends BaseTest {
	...
	public void testLocal() {
		try {
			MondayImpl m = (MondayImpl) mondayImpl;
			
			m.local();
			
		} catch (Exception e) {
			log.error("testLocal =====> ", e);
		}
	}
