...
import com.hua.bean.LoadProperty;
...
@ContextConfiguration(locations = {"classpath:conf/xml/spring-config-util.xml"})
public final class LoadPropertyTest extends BaseTest {
	...
	public void testSpringJunit() {
		try {
			...
			System.out.println(loadProperty.toString());
