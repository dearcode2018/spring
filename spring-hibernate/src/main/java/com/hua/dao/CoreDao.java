...
public interface CoreDao<E> {
	 ...
	 * @return
	 */
	public E get(final String sql, final Object id);
	 ...
	 * @return
	 */
	public List<E> search(final String sql);
	 ...
	 * @return
	 */
	public List<E> search(final String sql, final Object[] params);
	 ...
	 * @return
	 */
	public List<E> search(final String sql, final List<Object> params);
