...
public final class SpringJdbcTest extends BaseTest {
	...
	public void testCoreDao() {
		try {
			...
			// 不能使用 CoreDao.class 参数的方式，因为在ioc容器中有多个 CoreDao子类对象
			//CoreDao<?> coreDao = (CoreDao<?>) beanFactory.getBean(CoreDao.class);
	...
	public void testPersonDao() {
		try {
			//CoreDao coreDao = (CoreDao) beanFactory.getBean("coreDao");
			PersonDao personDao = (PersonDao) beanFactory.getBean(PersonDao.class);
