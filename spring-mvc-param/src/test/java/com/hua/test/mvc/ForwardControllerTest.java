...
public final class ForwardControllerTest extends BaseTest {
	...
	public void testGet() {
		try {
			 ...
			 * 设置请求参数
			 */
			requestBuilder.header("X-AUTH", "KD2LDKL0EKKM");
			requestBuilder.param("name", "张三");
			requestBuilder.param("age", "21");
			requestBuilder.param("sex", "true");
	...
	public void testGet2() {
		try {
			 ...
			 * 参数放在url中
			 */
			String url = prefix + "/get?name=张三&age=21&sex=true";
			// 请求构建器
			// get 方法
			MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get(url);
			// 设置 内容类型 Content-Type，默认是 application/x-www-form-urlencoded
	...
	public void testPost() {
		try {
			...
			searchBean.setName("admin");
			searchBean.setPassword("837374");
			searchBean.setCreateDt("2019-01-10 10:44:51");
