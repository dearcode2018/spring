 ...
 * SpringScheduleUtil
 */
public final class SpringScheduleUtil
{
	...
	private static final String[] configLocations = {
		...
		"spring-ioc-core.xml",
		"spring-ioc-test.xml",
		"spring-ioc-inject.xml",
		"spring-inject-autowire.xml",
		"spring-inject-constructor.xml",
		"spring-inject-setter.xml",
		"spring-inject-factory.xml",
		"spring-ioc-collection.xml",
		"spring-assemble.xml",
		};
