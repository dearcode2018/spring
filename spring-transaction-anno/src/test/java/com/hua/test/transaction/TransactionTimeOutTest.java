...
import com.hua.service.TransactionTimeOutService;
 ...
 *  */
// 使用事务注解 不能声明为final类型
public class TransactionTimeOutTest extends BaseTest {
	...
	public void testTimeOut1() {
		try {
			...
			entity = new Custom();
			entity.setName("Transaction TimeOut1");
			entity.setAddress("广州市天河东路112号");
			entity.setBalance(10.34);
			entity.setStatus(CustomStatus.NORMAL);
			
			/*
			 * DEBUG 2018-06-03 10:28:44.564   [main]    Looking up default 
			 * SQLErrorCodes for DataSource [org.apache.commons.dbcp2.BasicDataSource@867ba60]
			WARN  2018-06-03 10:28:44.599   [main]    Error while extracting database 
			 ...
			 */
			transactionTimeOutService.callRequiredMethodWithTransaction1(entity);
			
			
			
		} catch (Exception e) {
			log.error("testTimeOut1 =====> ", e);
		}
	}
	...
	public void testTimeOut2() {
		try {
			...
			/*
			 * 在callRequiredMethodWithTransaction2方法中没有执行数据库操作，
			 * 最后在当前方法的事务提交的时候抛如下异常:
			Could not commit JDBC transaction; nested exception is 
			com.mysql.jdbc.exceptions.jdbc4.MySQLNonTransientConnectionException: 
			No operations allowed after connection closed.
			 */
			transactionTimeOutService.callRequiredMethodWithTransaction2(entity);
			
			
			
		} catch (Exception e) {
			log.error("testTimeOut2 =====> ", e);
		}
	}
	...
	public void testTimeOut3() {
		try {
			...
			/*
 				Transaction timed out: deadline was Sun Jun 03 11:56:39 CST 2018
			 */
			transactionTimeOutService.callRequiredMethodWithTransaction3(entity);
			
			
			
		} catch (Exception e) {
			log.error("testTimeOut3 =====> ", e);
		}
	}
	...
	public void testTimeOut4() {
		try {
			...
			/*
 				Transaction timed out: deadline was Sun Jun 03 11:56:39 CST 2018
			 */
			transactionTimeOutService.callRequiredMethodWithTransaction4(entity);
			 ...
			 * connection [206,055] milliseconds 
			 * exceeds the maximum permitted value of [10,000] milliseconds
			 */
			
			
		} catch (Exception e) {
			log.error("testTimeOut4 =====> ", e);
		}
	}
