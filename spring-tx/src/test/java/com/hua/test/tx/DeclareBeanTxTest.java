...
@ContextConfiguration(locations = {
		...
		"classpath:conf/xml/tx-declare-bean.xml"})
public final class DeclareBeanTxTest extends BaseTest {
	...
	/**
	 * 在 tx-declare-bean.xml 中只给 insert声明
	 * 事务，而update方法没有声明，以此来测试
	 * 有、没有事务声明的效果
	 * -
	 */
