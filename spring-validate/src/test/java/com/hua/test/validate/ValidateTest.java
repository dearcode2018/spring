...
public final class ValidateTest extends BaseTest {
	...
	public void testValidate() {
		try {
			...
			//requestBuilder.param("temp", "12");
			requestBuilder.param("nickname", "hha");
			//requestBuilder.param("password", "12345");
